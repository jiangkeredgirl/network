...
cd /d %~dp0
MSBuild %sln_name%.sln /t:rebuild /p:platform=win32 /p:configuration=debug   /p:PlatformToolset=v%platform_version%
MSBuild %sln_name%.sln /t:rebuild /p:platform=win32 /p:Configuration=release /p:PlatformToolset=v%platform_version%
