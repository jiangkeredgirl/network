...
cd /d %~dp0
MSBuild %project_name%.vcxproj /t:rebuild /p:platform=win32 /p:configuration=debug   /p:PlatformToolset=v%platform_version%
MSBuild %project_name%.vcxproj /t:rebuild /p:platform=win32 /p:Configuration=release /p:PlatformToolset=v%platform_version%
